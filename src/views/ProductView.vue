            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="product-pic-zoom">
                  <img class="product-big-img" :src="product_default" alt="" />
                </div>
                <div class="product-thumbs">
                  ...
                  >
                    <div
                      ...
                      :class="thumbs[0] == product_default ? 'active' : ''"
                    >
                    ...
                    <div
                      ...
                      :class="thumbs[1] == product_default ? 'active' : ''"
                    >
                    ...
                    <div
                      ...
                      :class="thumbs[2] == product_default ? 'active' : ''"
                    >
                    ...
                    <div
                      ...
                      :class="thumbs[3] == product_default ? 'active' : ''"
                    >
...
import RelatedShayna from "@/components/RelatedSahyna.vue";
...
export default {
  ...
  data() {
    return {
      product_default: "img/mickey1.jpg",
      thumbs: [
        "img/mickey1.jpg",
        "img/mickey2.jpg",
        "img/mickey3.jpg",
